...
class RigControl(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        #init user interface
        self.ui = uic.loadUi("rigcontrol3.ui", self)
        ...
        self.ui.btnBeaImp.clicked.connect(Beacons.ImpBeacon)
...
class Beacons():
    ...
    def ReadG3USF(self, strFileIn, dbStations, dbMode):
        ...
        "ZD":["7=St Helena Is, 8=Ascension Is, 9=Tristan Da Cunha",""],
        "ZD7":["St Helena",""],
        "ZD8":["Ascension Is",""],
